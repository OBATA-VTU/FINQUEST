                                  ...
                                  {auth.user.avatarUrl ? (
                                      <img 
                                        ...
                                        onError={(e) => {
                                          ...
                                          if (parent) {
                                            parent.innerHTML = `<div class="flex items-center justify-center h-full text-indigo-700 font-bold">${auth.user?.name.charAt(0).toUpperCase()}</div>`;
                                          }
                                        }}
                                      />
                                  ) : (
                                      <div className="flex items-center justify-center h-full text-indigo-700 font-bold">{auth.user.name.charAt(0).toUpperCase()}</div>
                                  )}
                              </div>
