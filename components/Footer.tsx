    ...
    <footer className="relative bg-slate-950 text-slate-300 overflow-hidden border-t border-slate-800 mt-auto">
      ...
      <div className="container mx-auto px-6 py-16 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12">
          ...
          {/* CONTACT (3 cols) */}
          <div className="lg:col-span-3">
            <h3 className="font-bold text-white mb-6 uppercase text-xs tracking-widest border-l-2 border-indigo-500 pl-3">Contact Us</h3>
            <address className="not-italic space-y-4">
              <div className="flex items-start gap-3">
                  ...
                  <p className="text-sm text-slate-400">Department of Finance,<br/>Faculty of Administration,<br/>Adekunle Ajasin University.</p>
              </div>
