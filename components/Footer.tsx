...
export const Footer: React.FC = () => {
  ...
  const [socials, setSocials] = useState({
      ...
      twitter: '',
      instagram: '',
      whatsapp: 'https://wa.me/2348142452729' // Default to provided PRO number
  });
      ...
      const fetchContent = async () => {
          try {
              ...
              if (socDoc.exists()) {
                  ...
                  // Ensure whatsapp points to the specific PRO number unless explicitly overridden in DB to something else valid
                  if (!data.whatsapp) data.whatsapp = 'https://wa.me/2348142452729'; 
                  setSocials(data as any);
              }
          } catch (e) {
