...
export const AdminLayout: React.FC = () => {
    ...
    const guideContent = [
        ...
        { label: 'Directory Manager', desc: 'Update the list of department student leaders and available directory entries.' },
