...
export class ErrorBoundary extends React.Component<ErrorBoundaryProps, ErrorBoundaryState> {
  // FIX: Using a class property initializer for state. This is a more modern and concise syntax than using a constructor, and it resolves issues with TypeScript not recognizing the 'state' and 'props' properties on the component instance.
