...
export class ErrorBoundary extends React.Component<ErrorBoundaryProps, ErrorBoundaryState> {
  // FIX: Replaced constructor-based state initialization with a class property. This modern syntax is more concise and directly resolves the reported TypeScript errors where 'state' and 'props' were not found on the component type.
