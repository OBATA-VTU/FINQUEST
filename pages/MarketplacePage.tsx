                            ...
                            <div key={item.id} className="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 overflow-hidden flex flex-col">
                                ...
                                <div className="p-4 flex flex-col flex-1">
                                    ...
                                    <div className="mt-auto">
                                        ...
                                        <a href={`https://wa.me/${item.contact.replace('+', '')}`} target="_blank" rel="noopener noreferrer" className="mt-4 w-full text-center block py-2 bg-green-500 text-white font-bold text-sm rounded-lg hover:bg-green-600">Contact Seller</a>
                                    </div>
                                </div>
                            </div>
                        ))}
