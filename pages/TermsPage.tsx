  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900 py-16 transition-colors">
      <div className="container mx-auto px-4 max-w-4xl">
        <h1 className="text-4xl font-serif font-bold text-slate-900 dark:text-white mb-8">Terms of Service</h1>
        <div className="bg-white dark:bg-slate-800 p-8 rounded-xl shadow-sm space-y-6 text-slate-700 dark:text-slate-300 prose prose-slate dark:prose-invert max-w-none">
          ...
          <section>
            <h2 className="text-xl font-bold text-slate-900 dark:text-white mb-2">2. Intellectual Property Rights</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-slate-900 dark:text-white mb-2">3. User Representations</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-slate-900 dark:text-white mb-2">4. User Registration</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-slate-900 dark:text-white mb-2">5. Prohibited Activities</h2>
            <p>You may not access or use the Site for any purpose other than that for which we make the Site available. The Site may not be used in connection with any commercial endeavors except those that are specifically endorsed or approved by us.</p>
          </section>

          <section>
            <h2 className="text-xl font-bold text-slate-900 dark:text-white mb-2">6. Academic Integrity</h2>
