...
export const CommunityPage: React.FC = () => {
  ...
  if (!auth?.user) return <div className="text-center p-10 h-full flex items-center justify-center">Please login to access community.</div>;
          ...
          <div className="min-h-screen bg-slate-50 p-6 animate-fade-in">
              <div className="container mx-auto max-w-4xl">
                  <div className="text-center mb-10">
                      <h1 className="text-3xl font-bold text-slate-900 mb-2">Community Hub</h1>
                      <p className="text-slate-500">Connect with your peers across all platforms.</p>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                      ...
                      <button 
                        ...
                        className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200 hover:border-indigo-500 hover:shadow-xl transition-all group text-left relative overflow-hidden"
                      >
                          <div className="absolute top-0 right-0 p-4 opacity-5 group-hover:opacity-10 transition-opacity">
                              <svg className="w-24 h-24 text-indigo-600" fill="currentColor" viewBox="0 0 20 20"><path d="M2 5a2 2 0 012-2h7a2 2 0 012 2v4a2 2 0 01-2 2H9l-3 3v-3H4a2 2 0 01-2-2V5z" /><path d="M15 7v2a4 4 0 01-4 4H9.828l-1.766 1.767c.28.149.599.233.938.233h2l3 3v-3h2a2 2 0 002-2V9a2 2 0 00-2-2h-1z" /></svg>
                          </div>
                          ...
                          <h3 className="text-xl font-bold text-slate-900 mb-1">Student Chat Interface</h3>
                          <p className="text-slate-500 text-sm">Official live chat for verified students.</p>
                      </button>
                      ...
                      <a 
                        ...
                        target="_blank" 
                        rel="noreferrer"
                        className={`bg-white p-6 rounded-2xl shadow-sm border border-slate-200 hover:border-emerald-500 hover:shadow-xl transition-all group relative overflow-hidden ${!socialLinks.whatsapp && 'opacity-50 cursor-not-allowed'}`}
                      >
                          ...
                          <h3 className="text-xl font-bold text-slate-900 mb-1">Departmental Group</h3>
                          <p className="text-slate-500 text-sm">Join the general WhatsApp group.</p>
                      </a>
                      ...
                      <a 
                        ...
                        target="_blank" 
                        rel="noreferrer"
                        className={`bg-white p-6 rounded-2xl shadow-sm border border-slate-200 hover:border-sky-500 hover:shadow-xl transition-all group relative overflow-hidden ${!socialLinks.telegram && 'opacity-50 cursor-not-allowed'}`}
                      >
                          ...
                          <h3 className="text-xl font-bold text-slate-900 mb-1">Telegram Channel</h3>
                          <p className="text-slate-500 text-sm">Broadcasts and resources.</p>
                      </a>
                      ...
                      <a 
                        ...
                        target="_blank" 
                        rel="noreferrer"
                        className={`bg-white p-6 rounded-2xl shadow-sm border border-slate-200 hover:border-blue-600 hover:shadow-xl transition-all group relative overflow-hidden ${!socialLinks.facebook && 'opacity-50 cursor-not-allowed'}`}
                      >
                          <div className="w-12 h-12 bg-blue-100 rounded-xl flex items-center justify-center text-blue-600 mb-4 group-hover:scale-110 transition-transform">
                              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                          </div>
                          <h3 className="text-xl font-bold text-slate-900 mb-1">Facebook Group</h3>
                          <p className="text-slate-500 text-sm">Official student community page.</p>
                      </a>
                      ...
                      <a 
                        ...
                        target="_blank" 
                        rel="noreferrer"
                        className={`bg-white p-6 rounded-2xl shadow-sm border border-slate-200 hover:border-pink-500 hover:shadow-xl transition-all group relative overflow-hidden ${!socialLinks.instagram && 'opacity-50 cursor-not-allowed'}`}
                      >
                          ...
                          <h3 className="text-xl font-bold text-slate-900 mb-1">Instagram</h3>
                          <p className="text-slate-500 text-sm">Follow for photos and stories.</p>
                      </a>
                      ...
                      <a 
                        ...
                        target="_blank" 
                        rel="noreferrer"
                        className={`bg-white p-6 rounded-2xl shadow-sm border border-slate-200 hover:border-slate-800 hover:shadow-xl transition-all group relative overflow-hidden ${!socialLinks.twitter && 'opacity-50 cursor-not-allowed'}`}
                      >
                          <div className="w-12 h-12 bg-slate-100 rounded-xl flex items-center justify-center text-slate-800 mb-4 group-hover:scale-110 transition-transform">
                              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                          </div>
                          <h3 className="text-xl font-bold text-slate-900 mb-1">Twitter / X</h3>
                          <p className="text-slate-500 text-sm">Quick updates and threads.</p>
                      </a>
                      ...
                      <a 
                        ...
                        target="_blank" 
                        rel="noreferrer"
                        className={`bg-white p-6 rounded-2xl shadow-sm border border-slate-200 hover:border-black hover:shadow-xl transition-all group relative overflow-hidden ${!socialLinks.tiktok && 'opacity-50 cursor-not-allowed'}`}
                      >
                          <div className="w-12 h-12 bg-slate-900 rounded-xl flex items-center justify-center text-white mb-4 group-hover:scale-110 transition-transform">
                          ...
                          <h3 className="text-xl font-bold text-slate-900 mb-1">TikTok</h3>
                          <p className="text-slate-500 text-sm">Trends and fun moments.</p>
                      </a>
                  </div>
              </div>
          </div>
      ...
      <div className="flex-1 flex flex-col container mx-auto px-0 md:px-4 max-w-4xl h-full overflow-hidden">
        ...
        <div className="bg-white md:rounded-t-2xl border-b border-slate-200 p-4 shadow-sm flex items-center justify-between shrink-0 z-10">
            <div className="flex items-center gap-3">
                <button onClick={() => setView('hub')} className="p-2 hover:bg-slate-100 rounded-full transition">
