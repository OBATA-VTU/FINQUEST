    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            await addDoc(collection(db, 'lost_items'), {
                ...
                status: 'approved' // Post immediately, no approval needed
            });

            showNotification("Your report has been posted successfully!", "success");
            ...
            <div className="container mx-auto max-w-6xl">
                ...
                {loading ? (
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 animate-fade-in">
                        {[1, 2, 3, 4, 5, 6].map(i => (
                            <div key={i} className="bg-white dark:bg-slate-800 rounded-2xl shadow-sm h-96 p-4 space-y-4">
                        ...
                        <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden animate-fade-in-down" onClick={e => e.stopPropagation()}>
                            ...
                            <form onSubmit={handleSubmit} className="p-6 space-y-4">
                                <p className="text-xs text-amber-600 dark:text-amber-400 bg-amber-50 dark:bg-amber-900/20 p-2 rounded border border-amber-200 dark:border-amber-800">
                                    Your post will be public immediately. A notification will be sent to all students.
                                </p>
                                <div>
