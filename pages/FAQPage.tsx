...
const faqs: FAQItem[] = [
  ...
  { category: 'General', question: "How do I report a technical issue?", answer: "If you encounter any bugs or errors, please screenshot the issue and send it to the technical team via the WhatsApp contact link in the footer." },
  ...
  { category: 'Academic', question: "Are the past question answers verified?", answer: "We strive for accuracy, but answers provided in CBT practice are generated or sourced from students. Always cross-check with your lecture notes." },
  ...
  { category: 'Account', question: "How do I update my level?", answer: "Go to your Profile page, click 'Edit Profile', and select your new level from the dropdown menu." },
  ...
  { category: 'Community', question: "Is the chat moderated?", answer: "Yes, admins monitor the chat. Offensive or inappropriate behavior may lead to account suspension." },
