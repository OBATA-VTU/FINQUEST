        ...
        <div className="min-h-screen bg-slate-50 dark:bg-slate-950 transition-colors animate-fade-in pb-24">
            ...
            <div className="max-w-6xl mx-auto px-6">
                {loading ? (
                    ...
                    <div className="flex flex-col items-center justify-center py-40 bg-white dark:bg-slate-900 rounded-[4rem] border border-slate-100 dark:border-slate-800 shadow-sm text-center px-6">
