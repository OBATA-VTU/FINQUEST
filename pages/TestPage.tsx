...
export const TestPage: React.FC = () => {
  ...
  const renderResult = () => { 
    // FIX: Initialize `finalScore` with a number type to prevent TypeScript from inferring
    // its type as 'unknown', which would cause errors in arithmetic and comparison operations.
