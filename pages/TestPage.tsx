...
export const TestPage: React.FC = () => {
  ...
  const renderResult = () => { 
    // FIX: Explicitly typing `finalScore` as a number to resolve type inference issues.
    let finalScore: number = 0; let isPass = true; let title = "Game Over!"; let scoreLabel = "Points"; let scoreSuffix = "";
