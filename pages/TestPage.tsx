...
export const TestPage: React.FC = () => {
  ...
  const renderResult = () => { 
    ...
    // Both errors are resolved by initializing `finalScore` with a number type. This prevents
    // TypeScript from inferring its type as 'unknown' when not all code paths are analyzed.
