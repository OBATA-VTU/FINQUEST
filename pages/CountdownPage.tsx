...
const features = [
    { icon: <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" /></svg>, title: "Past Question Vault", description: "Access a comprehensive, verified library of past questions for all levels and courses." },
            ...
            <div className="relative z-10 flex flex-col items-center text-center max-w-7xl w-full">
                ...
                <footer className="w-full flex flex-col items-center mt-20 animate-fade-in-up" style={{animationDelay: '1100ms'}}>
                    ...
                    <div className="text-xs text-slate-500 font-bold">
                        &copy; {new Date().getFullYear()} FINSA AAUA | Developed by OBA. All rights reserved.
                    </div>
                </footer>
            </div>
        </div>
